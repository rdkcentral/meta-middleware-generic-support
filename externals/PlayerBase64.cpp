 ...
 */
char *player_base64_Encode(const unsigned char *src, size_t len)
{
 ...
 */
unsigned char *player_base64_Decode(const char *src, size_t *outLen, size_t srcLen)
{
...
unsigned char *player_base64_Decode(const char *src, size_t *len)
{
	return player_base64_Decode(src, len, strlen(src));
}
