...
#ifndef MOCK_AAMP_TSB_AD_RESERVATION_METADATA_H
...
/**
 * @class MockAampTsbAdReservationMetaData
 * @brief Mock implementation of AampTsbAdReservationMetaData
 */
class MockAampTsbAdReservationMetaData : public AampTsbAdReservationMetaData
{
public:
	MockAampTsbAdReservationMetaData()
		: AampTsbAdReservationMetaData(EventType::START, 0, "", 0) {}
