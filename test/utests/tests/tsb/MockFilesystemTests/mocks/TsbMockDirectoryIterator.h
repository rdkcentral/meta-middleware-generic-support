...
#ifndef __TSB_MOCK_DIRECTORY_ITERATOR__
#define __TSB_MOCK_DIRECTORY_ITERATOR__
...
class TsbMockDirectorIterator
{
public:
	MOCK_METHOD(std::filesystem::directory_entry, DeRef, (), (const));
