...
#ifndef MOCK_AAMP_TSB_AD_METADATA_H
...
/**
 * @class MockAampTsbAdMetaData
 * @brief Mock implementation of AampTsbAdMetaData
 */
class MockAampTsbAdMetaData : public AampTsbAdMetaData
{
public:
	MockAampTsbAdMetaData()
		: AampTsbAdMetaData(AdType::PLACEMENT, EventType::START, 0) {}
