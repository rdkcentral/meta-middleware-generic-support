...
IMAGE_INSTALL:append = " python3 python3-core python3-modules python3-pip python3-psutil gcc make python3-dev python3-setuptools binutils python3-wheel cargo"
