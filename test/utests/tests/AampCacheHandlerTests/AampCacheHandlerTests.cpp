...
TEST_F(AampCacheHandlerTest, InitFragCache)
{
    ...
    EXPECT_FALSE(res2);
    // Inserting the Url beyond the maxCachedInitFragmentsPerTrack and performing the RemoveInitFragCacheEntry ,later trying trying to retrieve the removed Url
