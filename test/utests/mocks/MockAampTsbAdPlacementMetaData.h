...
#ifndef MOCK_AAMP_TSB_AD_PLACEMENT_METADATA_H
#define MOCK_AAMP_TSB_AD_PLACEMENT_METADATA_H

#include <gmock/gmock.h>
#include "AampTsbAdPlacementMetaData.h"

/**
 * @class MockAampTsbAdPlacementMetaData
 * @brief Mock implementation of AampTsbAdPlacementMetaData
 */
class MockAampTsbAdPlacementMetaData : public AampTsbAdPlacementMetaData
{
public:
	MockAampTsbAdPlacementMetaData()
...
extern MockAampTsbAdPlacementMetaData* g_mockAampTsbAdPlacementMetaData;

#endif // MOCK_AAMP_TSB_AD_PLACEMENT_METADATA_H
